...
//#region node_modules/.nitro/vite/services/ssr/assets/profile-DXCzgVDC.js
...
var getPublicProfile = createServerFn({ method: "GET" }).validator((userId) => userId.trim()).handler(createSsrRpc("0e7a8b2c9bea19bdb107f5b2b2da3c2ee12deed900d6705770e11c06c6ac9d7a"));
var listPublicAnnotationsByUser = createServerFn({ method: "GET" }).validator((userId) => userId.trim()).handler(createSsrRpc("85b36a8ae330be55ee95794310da400d61502ab34f6b4021345db19b8fbeffbb"));
//#endregion
