...
import { n as __exportAll$1 } from "./ssr.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/client-Cb5BphvN.js
var client_Cb5BphvN_exports = /* @__PURE__ */ __exportAll({
	a: () => signInWithEmail,
	i: () => signIn,
	n: () => client_exports,
	o: () => signOut,
...
var authClient = createAuthClient({
	...
	fetchOptions: {
		...
		onSuccess(ctx) {
			...
			try {
				const data = ctx.data;
				if (data?.token && typeof data.token === "string") setBearerToken(data.token);
			} catch {}
		}
	}
});
...
async function signInWithEmail(input) {
	...
	const token = data?.token ?? getBearerToken();
...
//#endregion
export { signInWithEmail as a, signIn as i, client_Cb5BphvN_exports as n, signOut as o, getBearerToken as r, signUpWithEmail as s, authClient as t };
