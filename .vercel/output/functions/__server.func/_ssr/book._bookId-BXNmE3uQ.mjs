...
import { n as formatBytes, r as formatCount } from "./utils-D0dWsYTS.mjs";
...
import { A as Clock, M as Check, N as BookOpen, i as Upload, o as Trash2, s as Star } from "../_libs/lucide-react.mjs";
import { t as useLibraryStore } from "./library---StLbl3.mjs";
import { t as Route } from "./book._bookId-BxMcutHq.mjs";
import { t as BookCover } from "./BookCover-BK7lziiY.mjs";
import { t as Progress } from "./progress-DP36Q2v3.mjs";
import { i as listBookAnnotations } from "./social-DHuxPxxu.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/book._bookId-BXNmE3uQ.js
...
function BookDetailPage() {
	...
	(0, import_react.useEffect)(() => {
		listBookAnnotations({ data: bookId }).then(setAnnotations).catch(() => setAnnotations([]));
	}, [bookId]);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [
								...
								annotations.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: [annotations.length, " 条公开批注"] })
							]
						}),
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
				className: "mb-4 text-lg font-medium tracking-tight",
				children: "公开批注"
			}), annotations.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: "rounded-[var(--radius-xl)] border border-dashed border-border py-10 text-center text-sm text-fg-muted",
				children: "还没有公开批注。登录后在阅读器中选中文字即可画线分享。"
			}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "space-y-3",
				children: annotations.map((a) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
