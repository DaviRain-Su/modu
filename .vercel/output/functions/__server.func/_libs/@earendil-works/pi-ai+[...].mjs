...
//#endregion
//#region node_modules/@earendil-works/pi-ai/dist/utils/json-parse.js
...
//#endregion
//#region node_modules/@earendil-works/pi-ai/dist/utils/text.js
...
var openAICompletionsApi = () => lazyApi(() => Promise.resolve().then(() => openai_completions_exports));
//#endregion
...
//#endregion
//#region node_modules/@earendil-works/pi-ai/dist/utils/error-body.js
...
function pickBodyText(error) {
	...
	if (isNonEmptyObject(error.error)) return safeJsonStringify$1(error.error);
	const responseBody = error.$response?.body;
	if (typeof responseBody === "string") return responseBody;
	if (isReadableStreamLike(responseBody)) return void 0;
	if (isNonEmptyObject(responseBody)) return safeJsonStringify$1(responseBody);
}
...
//#endregion
//#region node_modules/@earendil-works/pi-ai/dist/utils/hash.js
...
//#endregion
//#region node_modules/@earendil-works/pi-ai/dist/utils/provider-retry.js
...
//#endregion
//#region node_modules/@earendil-works/pi-ai/dist/api/github-copilot-headers.js
...
//#endregion
export { createProvider as i, contentText as n, createModels as r, openAICompletionsApi as t };
